...
(3, 'We offer the following programs<br>\r\n		We offer the following Programs<br>\r\n		1.BTECH IN CIVIL ENGINEERING <br>2.BTECH IN MECHANICAL ENGINEERING <br>3.BTECH IN ELECTRICAL &amp; ELECTRONIC ENGINEERING (B.E.E.E.)<br>4.DIPLOMA IN ELECTRONICS &amp; COMMUNICATION ENGINEERING (D.E.C.E.)<br>5.MASTERS IN COMPUTER APPLICATIONS<br>6.DIPLOMA IN INFORMATION TECHNOLOGY (D.I.T.)'),
...
(1, 'Registration form is now available in our college campus. come now to be registerd', 'Registration form is available in our college so if you want to join our in our college please come with 20000 for that registration form'),
